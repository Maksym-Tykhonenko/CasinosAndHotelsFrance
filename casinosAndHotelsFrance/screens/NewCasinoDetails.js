...
const NewCasinoDitails = ({ navigation, route }) => {
    ...
    const { hotel, qwantityOfRooms, location, description } = plase;
    ...
    useEffect(() => {
      ...
      const setData = async () => {
        try {
            ...
            await AsyncStorage.setItem("photoFromNewCasinoDitails", jsonData);
    ...
    const getData = async () => {
        try {
            const jsonData = await AsyncStorage.getItem('photoFromNewCasinoDitails');
            if (jsonData !== null) {
    ...
    return (
        <View style={{ flex: 1, position: 'relative', backgroundColor: '#0c1e3b' }}>
            ...
            {!loaderIsLoaded ? (
                ...
                >
                    <View style={{ flex: 1, borderRadius: 15, marginTop: 40, marginBottom: 30, marginHorizontal: 20, paddingHorizontal: 5, paddingVertical: 10, backgroundColor: 'rgba(0, 0, 0, 0.5)',  }}>
                        ...
                        <ScrollView>
                            <View style={{ padding: 10, paddingTop: 10 }}>
                                ...
                                <View style={{ marginBottom: 15 }}>
                                    ...
                                    <Text style={{ color: '#e9c860' }}><Text style={{ fontWeight: 'bold' }}>Number of Rooms:</Text> Approximately {qwantityOfRooms} rooms</Text>
                                ...
                                <View >
                                    <MapView
                                        ...
                                        initialRegion={{
                                            latitude: 46.64617658206285,
                                            longitude:  2.5035701020155465,
                                            latitudeDelta: 0.922,
